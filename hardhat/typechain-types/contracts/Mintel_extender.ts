...
export declare namespace Mintel_extender {
...
export interface Mintel_extenderInterface extends utils.Interface {
  functions: {
...
export interface Mintel_extender extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Mintel_extenderInterface;
  ...
  functions: {
    ...
    viewProjects(
      overrides?: CallOverrides
    ): Promise<[Mintel_extender.ProjectStructOutput[]]>;
